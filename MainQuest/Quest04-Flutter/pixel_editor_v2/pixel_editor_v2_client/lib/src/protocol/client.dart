...
/// {@category Endpoint}
class EndpointPixelParty extends _i1.EndpointRef {
  EndpointPixelParty(_i1.EndpointCaller caller) : super(caller);

  @override
  String get name => 'pixelParty';
...
class Client extends _i1.ServerpodClientShared {
  Client(
    ...
    pixelParty = EndpointPixelParty(this);
  }

  late final EndpointPixelParty pixelParty;
